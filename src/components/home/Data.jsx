...
const Data = () => {
  return (
      <div className="home__data">
        <h1 className="home__title">Tanishq Soni
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">
            I am a software developer having 3 years of experience based in India, I am very passionate and dedicated to my work.
        </p>
